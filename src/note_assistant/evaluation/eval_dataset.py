...
def get_builtin_dataset() -> EvalDataset:
    ...
    questions = [
        ...
        EvalQuestion(
            ...
            relevant_files=["embedding.md", "BGE-M3.md"],
        ),
        EvalQuestion(
            ...
            relevant_files=["BM25.md", "向量检索.md"],
        ),
        EvalQuestion(
            ...
            relevant_files=["Reranker.md", "Cross-Encoder.md"],
        ),
        EvalQuestion(
            ...
            relevant_files=["chunking.md", "splitter.md"],
        ),
        EvalQuestion(
            ...
            relevant_files=["hybrid.md", "alpha.md"],
        ),
        EvalQuestion(
            ...
            relevant_files=["query_rewrite.md"],
        ),
        EvalQuestion(
            ...
            relevant_files=["GraphRAG.md", "wiki_graph.md"],
        ),
        EvalQuestion(
            ...
            relevant_files=["incremental_index.md", "sync.md"],
        ),
        EvalQuestion(
            ...
            relevant_files=["evaluation.md", "metrics.md"],
        ),
    ]
