...
> 个人知识库 RAG 系统，支持Naive rag和Agentic rag双模运行，Naive rag用于快速回答，Agentic RAG用于精确详细回答，支持文字和图片的双重检索，支持mermaid直接渲染，可以从问答的来源中快速链接到对应知识库文档。解决了个人智库检索困难，回答问题不精准的问题。
...
| 能力                               | 说明                                                                                                             |
|----------------------------------|----------------------------------------------------------------------------------------------------------------|
| **图片多模态理解 / 图片问答**               | 索引期对笔记插图做 VLM 结构化理解（描述/OCR/实体/类型），与文本同池检索；命中图时带出同章节文本邻居防误导，答案直接渲染原图，也可以渲染mermaid流程图                           |
